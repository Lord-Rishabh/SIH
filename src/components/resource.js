            ...
            <div className="project-boxes jsGridView">
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style={{ backgroundColor: "#e9e7fd" }}>
                        ...
                        <div className="project-box-content-header">
                            <img className="box-content-subheader" src="https://i.ytimg.com/vi/6CWVNRAIAEY/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLB_ih8msZgk0Cg8DEEtmoVjzgBdJg"
                ...
                <div className="project-box-wrapper">
                    <div className="project-box">
                        ...
                        <div className="project-box-content-header">
                            <img className="box-content-subheader" src="https://i.ytimg.com/vi/CysMrYVgyGU/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLDS0LWQj0URI2p6wVphjPRRYElxoA"
                                heigth="100px" width="200px" />
                        </div>
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style={{ backgroundColor: "#ffd3e2" }}>
                        ...
                        <div className="project-box-content-header">
                            <img className="box-content-subheader" src="https://i.ytimg.com/vi/enADmGHZuiY/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLBaYfEV1RHg_7tMyOcl3L1QM4u5iw"
                                heigth="100px" width="200px" />
                        </div>
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style={{ backgroundColor: "#c8f7dc" }}>
                        ...
                        <div className="project-box-content-header">
                            <img className="box-content-subheader" src="https://i.ytimg.com/vi/mQk6Y5B_0Mk/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLDkFgm7W_RCH7e0TQTItAmdXoS3HA"
                ...
                <div className="project-box-wrapper">
                    <div className="project-box" style={{ backgroundColor: "#d5deff" }}>
                        ...
                        <div className="project-box-content-header">
                            <img className="box-content-subheader" src="https://i.ytimg.com/vi/qWFKDj41eVw/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLC2JTgDjxDwvNiUelNuCiD-QDnoqA"
                                heigth="150px" width="200px" />
                        </div>
                        <div className="box-progress-wrapper">
                            <p className="box-progress-header">Progress</p>
