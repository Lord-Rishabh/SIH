...
const Topbar = () => {
  ...
  return (
    ...
    <div className="app-header-left">
      ...
      <p className="app-name">Krishna</p>
    ...
    <div className="app-header-right">
      ...
      <button className="add-btn" title="Add New Project">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" className="feather btn-icon feather-plus">
      ...
      <button className="profile-btn">
        <img alt="imagez" src="https://assets.codepen.io/3306515/IMG_2025.jpg" />
        <span>Admin</span>
      </button>
    </div>
